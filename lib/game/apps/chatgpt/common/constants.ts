...
export const vivienneConversations: ChatGPTConversation[] = [
    ...
    },
    {
        ...
        messages: [
            ...
            { sender: "user", text: "It doesn’t matter now. I’ve made up my mind. This coming birthday will be my last, 02/14/2022.", evidence: "Her birthday, 02142022... I wonder if that will be useful somewhere...", last: true },
